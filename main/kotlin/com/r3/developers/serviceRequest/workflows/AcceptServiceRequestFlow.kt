...
@InitiatingFlow(protocol = "Accept-Service-request")
class AcceptServiceRequestFlow : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        val request = requestBody.getRequestBodyAs(jsonMarshallingService, AcceptServiceRequestModel::class.java)
...
//        }
    ...
    outputServiceRequestStateData.updatedOn = Instant.now().toEpochMilli()
        ...
        outputServiceRequestStateData.status ="Accepted"
        ...
        val transaction = utxoLedgerService.createTransactionBuilder()
            ...
            .addCommand(ServiceRequestContract.Accept())
...
@InitiatedBy(protocol = "Accept-Service-request")
class AcceptServiceRequestResponderFlow: ResponderFlow {
