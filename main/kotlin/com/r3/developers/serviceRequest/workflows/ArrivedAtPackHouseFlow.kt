...
import com.r3.developers.serviceRequest.models.ArrivedAtPackHouseModel
...
@InitiatingFlow(protocol = "Arrive-at-pack-house")
class ArrivedAtPackHouseFlow : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        val request = requestBody.getRequestBodyAs(jsonMarshallingService, ArrivedAtPackHouseModel::class.java)


        val requestId =request.requestId
        val arrivedAtPackHouseOn = Instant.now().toEpochMilli()
      //  val batchId = request.batchId
        ...
        outputServiceRequestStateData.arrivedAtPackHouseModel= request
        outputServiceRequestStateData.updatedOn = Instant.now().toEpochMilli()
       // outputServiceRequestStateData.arrivedAtPackHouseOn=  Instant.now().toEpochMilli()
        outputServiceRequestStateData.status ="Arrive-at-pack-house"
        ...
        val transaction = utxoLedgerService.createTransactionBuilder()
            ...
            .addCommand(ServiceRequestContract.ArrivedAtPackHouse())
...
@InitiatedBy(protocol = "Arrive-at-pack-house")
class ArrivedAtPackHouseResponderFlow: ResponderFlow {
