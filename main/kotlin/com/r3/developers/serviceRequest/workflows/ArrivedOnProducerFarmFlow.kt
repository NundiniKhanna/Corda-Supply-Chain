...
//data class ServiceRequestFlowData(
...
//)
@InitiatingFlow(protocol = "Arrived-On-Producer-Farm")
class ArrivedOnProducerFarmFlow : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        val request = requestBody.getRequestBodyAs(jsonMarshallingService, ArrivedOnProducerFarmModel::class.java)
...
//        require(inputServiceRequestStateRef.status == "Created Service Request") {
//            "Accept Service Request can only happen if the previous status was 'Created Service Request'."
//        }
        outputServiceRequestStateData.arrivedOnProducerFarmModel= request
        outputServiceRequestStateData.updatedOn = Instant.now().toEpochMilli()
        outputServiceRequestStateData.status = "Arrive-on-producer-farm"
        ...
        /*    val createServiceRequestModel = CreateServiceRequestModel(
                // Provide appropriate values for createServiceRequestModel
            )*/
        ...
        val transaction = utxoLedgerService.createTransactionBuilder()
            ...
            .addCommand(ServiceRequestContract.ArrivedOnProducerFarm())
...
@InitiatedBy(protocol = "Arrived-On-Producer-Farm")
class ArrivedOnProducerFarmResponderFlow: ResponderFlow {
