...
@InitiatingFlow(protocol = "Confirm-Payment-flow")
class ConfirmPaymentFlow : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        val request = requestBody.getRequestBodyAs(jsonMarshallingService, ConfirmPaymentModel::class.java)


        //val requestId = request.requestId
        val saleId = request.saleId
        val notary = notaryLookup.notaryServices.single()
        val confirmPaymentDate = Instant.now().toEpochMilli()
        ...
        outputSaleRequestStateData.confirmPaymentData= request
        outputSaleRequestStateData.updatedOn = Instant.now().toEpochMilli()
        //outputSaleRequestStateData.confirmPaymentDate =Instant.now().toEpochMilli()
        outputSaleRequestStateData.status ="confirm-payment-data"
        ...
        val transaction = utxoLedgerService.createTransactionBuilder()
            ...
            .addCommand(SaleContract.ConfirmPaymentData())
...
@InitiatedBy(protocol = "Confirm-Payment-flow")
class ConfirmPaymentResponderFlow: ResponderFlow {
