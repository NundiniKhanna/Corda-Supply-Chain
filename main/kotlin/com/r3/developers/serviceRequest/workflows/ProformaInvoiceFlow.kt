...
@InitiatingFlow(protocol = "Proforma-Invoice-flow")
class ProformaInvoiceFlow : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        val request = requestBody.getRequestBodyAs(jsonMarshallingService, ProformaInvoiceModel::class.java)


        //val requestId = request.requestId
        val batchId = request.batchId
        val proFormaUpdatedOn = Instant.now().toEpochMilli()
        ...
        outputBatchRequestStateData.proformaInvoiceModel= request
        //outputBatchRequestStateData.recordedOn = Instant.now().toEpochMilli()
       // outputBatchRequestStateData.proFormaUpdatedOn= Instant.now().toEpochMilli()
        outputBatchRequestStateData.status ="creating-proforma-invoice"
        ...
        val transaction = utxoLedgerService.createTransactionBuilder()
            ...
            .addCommand(BatchContract.PerformaInvoice())
...
@InitiatedBy(protocol = "Proforma-Invoice-flow")
class ProformaInvoiceResponderFlow: ResponderFlow {
