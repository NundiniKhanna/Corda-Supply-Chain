...
import com.r3.developers.serviceRequest.models.SalesInvoiceModel
...
@InitiatingFlow(protocol = "Sales-Invoice-flow")
class SalesInvoiceFlow : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        val request = requestBody.getRequestBodyAs(jsonMarshallingService, SalesInvoiceModel::class.java)
        ...
        outputSaleRequestStateData.salesInvoiceData= request
        outputSaleRequestStateData.updatedOn = Instant.now().toEpochMilli()
        outputSaleRequestStateData.status ="sales-invoice-data"
        ...
        val transaction = utxoLedgerService.createTransactionBuilder()
            ...
            .addCommand(SaleContract.SalesInvoiceData())
...
@InitiatedBy(protocol = "Sales-Invoice-flow")
class SalesInvoiceResponderFlow: ResponderFlow {
