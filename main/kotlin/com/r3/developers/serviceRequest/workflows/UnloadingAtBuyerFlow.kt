...
import com.r3.developers.serviceRequest.models.UnloadingAtBuyerModel
...
@InitiatingFlow(protocol = "unload-at-buyer-flow")
class UnloadingAtBuyerFlow : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        val request = requestBody.getRequestBodyAs(jsonMarshallingService, UnloadingAtBuyerModel::class.java)
        ...
        outputSaleRequestStateData.unloadingAtBuyerData= request
        outputSaleRequestStateData.updatedOn = Instant.now().toEpochMilli()
        outputSaleRequestStateData.status ="unload-at-buyer-data"
        ...
        val transaction = utxoLedgerService.createTransactionBuilder()
            ...
            .addCommand(SaleContract.UnloadAtBuyerData())
...
@InitiatedBy(protocol = "unload-at-buyer-flow")
class UnloadingAtResponderFlow: ResponderFlow {
